...
<head>
    ...
    <title>The Lottery | Result</title>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">Try the new tool to print reports of your bets in pdf!</span>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card shadow mb-4 card-novaaposta mx-auto">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">See the numbers drawn!</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6 d-flex align-items-center justify-content-center">
                                            <div>
                                                <h4>Bet Id: <strong>5813</strong></h4>
                                                <h4>Errors: <strong>6</strong></h4>
                                                <h4>Hits: <strong>9</strong></h4>
                                                <h4>Result: <strong>You lost!</strong></h4>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <img class="imagem-novaaposta img-fluid" alt="money"
                                                src="https://image.freepik.com/free-vector/man-overspending-throwing-coins-dustbin-money-waste-unprofitable-investment-bad-finances-management-financial-bankruptcy-guy-losing-savings_335657-3567.jpg">
                                        </div>
                                    </div>

                                </div>
                                <div class="card-footer text-center">
                                    <a href="<c:url value="new_bet"/>"
                                        class="btn btn-primary btn-icon-split btn-lg mt-3 mb-3 mr-4">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-plus"></i>
                                        </span>
                                        <span class="text">New Bet</span>
                                    </a>
                                    <a href="<c:url value="bets"/>" class="btn btn-primary btn-icon-split btn-lg mt-3 mb-3 mr-4">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-cubes"></i>
                                        </span>
                                        <span class="text">Total Bets</span>
                                    </a>
                                </div>
                            </div>
                            <!-- Fim card-->
